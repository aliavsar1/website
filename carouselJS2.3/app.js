...
console.log(carouselImages.length, " bu rakam, carouselImages'ın");
...
//counter 1 ise, size=1020x1=1020px oluyor ama burada eksi halde. bu satırda, slaytta lastclone'u değil de birinci slaytın görünmesini sağladık
...
carouselSlide.addEventListener("transitionend", () => {
  console.log(counter, " transitionend in içi");
