...
nextBtn.addEventListener("click", () => {
  ...
  if (counter >= carouselImages.length - 1) return; //Bu satırı sonradan sildi, çünkü burada counter sıfır ya da altına düşmüyor. ve bu hale getirdi, çünkü burada da butona hızlı basınca sayı çok büyüyor ve resimler görünmüyor.
